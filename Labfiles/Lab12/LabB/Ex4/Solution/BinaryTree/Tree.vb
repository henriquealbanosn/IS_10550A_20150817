Public Class Tree(Of TItem As IComparable)
    ...
    Public Shared Function BuildTree(Of TreeItem As IComparable)(ByVal nodeValue As TreeItem, ByVal ParamArray values() As TreeItem) As Tree(Of TreeItem)
        Dim testTree As Tree(Of TreeItem) = New Tree(Of TreeItem)(nodeValue)

        For Each item As TreeItem In values
            testTree.Add(item)
        Next
