...
#End Region
    ...
    Public Sub CreateQueryandFormatResultsTest()
        ...
        For testCount As Integer = 0 To testQueryCriteria.GetLength(0) - 1
            ...
            Dim actual As IEnumerable(Of TestResult) = target.CreateQuery(dateStart, dateEnd, temperatureStart, temperatureEnd, appliedStressStart, appliedStressEnd, deflectionStart, deflectionEnd)
            ...
            Dim expectedFormattedResultsLength As Integer = CType(testQueryCriteria(testCount, 9), Integer)
